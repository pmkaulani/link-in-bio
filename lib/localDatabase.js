...
function getInitialDB() {
  return {
    profiles: [
      { id: 'local-test-id', username: 'amelie', display_name: 'Amélie Poulain', is_verified: false, account_status: 'active' },
      { id: 'scam-account-id', username: 'freecrypto', display_name: 'Free Crypto Giveaway', is_verified: false, account_status: 'active' },
    ],
    blocks: [
      { id: 'block-scam-1', profile_id: 'scam-account-id', title: 'Claim Free Crypto', url: 'https://phishing.example.com', is_disabled: false },
    ],
    platform_admins: [
      { user_id: 'local-test-id', role: 'superadmin' },
    ],
    reports: [
      { id: 'rep-1', target_type: 'block', target_id: 'block-scam-1', reason: 'phishing', status: 'pending', created_at: new Date().toISOString() },
    ],
