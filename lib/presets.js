...
export const QUICK_SOCIALS = [
  { icon: 'snapchat', title: 'Snapchat', urlPrefix: 'https://snapchat.com/add/' },
  ...
  { icon: 'whatsapp', title: 'WhatsApp', urlPrefix: 'https://wa.me/' },
  { icon: 'twitter', title: 'X / Twitter', urlPrefix: 'https://x.com/' },
  { icon: 'spotify', title: 'Spotify', urlPrefix: 'https://open.spotify.com/' },
  { icon: 'applemusic', title: 'Apple Music', urlPrefix: 'https://music.apple.com/' },
  { icon: 'pinterest', title: 'Pinterest', urlPrefix: 'https://pinterest.com/' },
  { icon: 'reddit', title: 'Reddit', urlPrefix: 'https://reddit.com/user/' },
  ...
  { icon: 'patreon', title: 'Patreon', urlPrefix: 'https://patreon.com/' },
  { icon: 'substack', title: 'Substack', urlPrefix: 'https://substack.com/@' },
