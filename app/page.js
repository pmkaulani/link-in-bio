...
const SHOWCASE_THEMES = [
  {
    ...
    handle: '@peter.dev',
    displayName: 'Peter K.',
    bio: 'Software architect & open-source creator. Building the modern web with Next.js.',
    avatarText: 'PK',
    links: [
      { title: 'Interactive Web Portfolio', subtitle: 'Case studies & design engineering', icon: 'globe' },
      { title: 'YouTube: Dev Tutorials', subtitle: 'Weekly UI breakdowns & live coding', icon: 'youtube' },
      { title: 'Open Source Repositories', subtitle: 'Explore 30+ GitHub projects', icon: 'github' },
      { title: 'Join Discord Server', subtitle: 'Community of 3,500+ builders', icon: 'discord' },
    ],
    socials: ['telegram', 'facebook', 'instagram', 'youtube', 'github'],
  },
  {
    id: 'aurora',
    name: 'Aurora Glass',
    ...
    bio: 'Visual artist, photographer & director based in Nairobi. Available for commissions.',
    avatarText: 'SC',
    links: [
      { title: '2026 Photography Collection', subtitle: 'Limited fine-art print drop', icon: 'camera' },
      { title: 'Instagram Portfolio', subtitle: 'Daily behind-the-scenes & shoots', icon: 'instagram' },
      { title: 'Book a Commercial Shoot', subtitle: 'Studio & brand collaboration inquiries', icon: 'email' },
    ],
  ...
  },
  {
    ...
    bio: 'Electronic music producer & DJ. Stream new single "Neon Skyline" everywhere.',
    avatarText: 'AR',
    links: [
      { title: 'Listen on Spotify', subtitle: 'Stream new EP "Afterlight"', icon: 'spotify' },
      { title: 'Upcoming 2026 Tour Dates', subtitle: 'London, Berlin, New York, Tokyo', icon: 'globe' },
  ...
  },
  {
    ...
    handle: '@matrix.labs',
    displayName: 'Neo Ventures',
    bio: 'AI research lab & builder studio. Democratizing intelligent edge algorithms.',
    avatarText: 'NV',
    links: [
      { title: 'Read Research Papers', subtitle: 'Published on arXiv & GitHub', icon: 'globe' },
      { title: 'Follow on X (Twitter)', subtitle: 'Technical threads & announcements', icon: 'twitter' },
      { title: 'Join Early Access Beta', subtitle: 'Fast token deployment pipeline', icon: 'zap' },
    ],
  ...
  },
  {
    ...
    handle: '@atelier.vogue',
    displayName: 'Maison Studio',
    bio: 'Curated architectural fashion, bespoke garments & seasonal lookbooks.',
    avatarText: 'MS',
    links: [
      { title: 'Spring / Summer Lookbook', subtitle: 'Explore high fashion catalog', icon: 'camera' },
      { title: 'Shop Online Boutique', subtitle: 'Complimentary global shipping', icon: 'store' },
      { title: 'Book Private Fitting', subtitle: 'By appointment in Milan & Paris', icon: 'email' },
    ],
            ...
            <div className="mt-8 w-full max-w-md">
              ...
              >
                ...
                <input
                  ...
                  className="w-full bg-transparent px-1 text-xs sm:text-sm font-bold text-white outline-none placeholder:text-zinc-700"
                />
                <MagneticButton
                  as="button"
                  type="submit"
          ...
          >
            <div className="flex items-center rounded-[8px] border border-zinc-800 bg-zinc-900 px-3.5 py-3 w-full">
              ...
              <input
                ...
                placeholder="yourname"
                className="w-full bg-transparent text-xs font-bold text-white outline-none pl-1"
              />
            </div>
            <MagneticButton
              as="button"
